...
- **deploy-info.json.example:** Estructura correcta (network, tokenAddress, implementationAddress, proxyAdminAddress, constructorParams); alineado con USDT (name "Tether USD", symbol "USDT", decimals 6).
