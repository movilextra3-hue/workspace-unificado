...
contract TRC20TokenUpgradeable is Initializable {
    ...
    bytes32 public constant PERMIT_TYPEHASH =
        ...
        ); // solhint-disable-line gas-small-strings
    ...
    function mint(
        address to,
        uint256 amount
    ) public onlyOwner whenNotBlacklisted(to) nonReentrant {
    ...
    function recoverTRX(address to) public onlyOwner nonReentrant {
        ...
        // wake-disable-next-line balance-relied-on -- owner-only; recuperación deliberada.
