...
// TRC20TokenUpgradeable.sol incluye Initializable (archivo único). No existe contracts/Initializable.sol.
...
function main() {
  ...
  const metadata = {
    ...
    note: 'Verificar cada contrato con su dirección. Token = Proxy. Ver docs/vitacora/CONSOLIDACION_COMPLETA_TODO.md'
  };
