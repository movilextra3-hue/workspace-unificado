...
$outputFile = "C:\Users\Administrador\Desktop\solana_address_info_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
$outputTxt = "C:\Users\Administrador\Desktop\solana_address_info_$(Get-Date -Format 'yyyyMMdd_HHmmss').txt"
